...
void humanGame(vector <vector<Cell>> &board, bool isTypeSix); /* Game type that user plays */

void computerGame(vector <vector<Cell>> &board, bool isTypeSix); /* Game type that computer plays */
